...
const ProjectsSection = () => {
  ...
  const handleChange2 = (panel2) => (event, isExpanded2) => {
    ...
    (isExpanded2 ? setExpandedBrightness2("linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 2)), url(/assets/MuseumMapper/MuseumMapperShowcase.gif)")
      :
  ...
  const handleChange3 = (panel) => (event, isExpanded) => {
    ...
    (isExpanded ? setExpandedBrightness3("linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 2)), url(/assets/RapidGames/RapidGamesShowcase.gif)")
      :
  ...
  const handleChange4 = (panel) => (event, isExpanded) => {
    ...
    (isExpanded ? setExpandedBrightness4("linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 1.2)), url(/assets/BerserkersTrial/Filmage-2021-12-16_130308.gif)")
      :
